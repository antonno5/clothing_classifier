...
from modules.resnet_data_module import ResNetDataModule
from utils.data_handler import ensure_data_unpacked
from utils.logger import get_logger
from utils.model_getter import get_model
...
def main(test_dir: str, checkpoint_name: str) -> None:
    with initialize(config_path="../configs", version_base="1.1"):
        ...
        datamodule = ResNetDataModule(config)
